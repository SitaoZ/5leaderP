...
if __name__ == '__main__':
    # norm_select.csv
    ath = pd.read_csv('/home/zhusitao/project/DPI/01.ath/All_isoforms_peak_process/09.jbrowser/regression/regression_data.csv')
    ...
    cotton = pd.read_csv('/home/zhusitao/project/DPI/03.cotton/All_isoforms_peak_process/09.jbrowser/regression/regression_data.csv')
    maize = pd.read_csv('/home/zhusitao/project/DPI/04.maize/All_isoforms_peak_process/09.jbrowser/regression/regression_data.csv')
    soybean = pd.read_csv('/home/zhusitao/project/DPI/05.soybean/All_isoforms_peak_process/09.jbrowser/regression/regression_data.csv')
