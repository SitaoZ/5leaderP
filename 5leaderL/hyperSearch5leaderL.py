...
from aTSS.models import RegGruNet
...
def train(config, checkpoint_dir = None, epochs=5):
    ...
    """
    # step1 data
    train_data = np.load('../data/regress_data.npy')
    train_label = np.load('../data/regress_label.npy')
    ...
    train_set, valid_set = train_test_split(train_set, test_size=0.1, random_state=4)
