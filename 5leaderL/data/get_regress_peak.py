...
if __name__ == '__main__':
    ath = pd.read_csv('./regression_data_150_peakCount_20230122.csv')
    TBF1 = ath[ath.Locus == 'AT4G36990.1']
    TBF1.to_csv('TBF1.csv', index=False)
    ath = ath[~ath.Locus.str.contains('AT4G36990.1')]
    #rice = pd.read_csv('/home/zhusitao/project/DPI/02.rice/peak_process/09.jbrowser/another_way_regression_data_150_peak.csv')
    #cotton = pd.read_csv('/home/zhusitao/project/DPI/03.cotton/peak_process/09.jbrowser/another_way_regression_data_150_peak.csv')
    #maize = pd.read_csv('/home/zhusitao/project/DPI/04.maize/peak_process/09.jbrowser/another_way_regression_data_150_peak.csv')
    #soybean = pd.read_csv('/home/zhusitao/project/DPI/05.soybean/peak_process/09.jbrowser/another_way_regression_data_150_peak.csv')
